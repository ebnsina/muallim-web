...
export { default as CertificateCanvas } from './CertificateCanvas.svelte';
...
export { default as IDCardCanvas } from './IDCardCanvas.svelte';
...
export { default as MiniCalendar, type Deadline } from './MiniCalendar.svelte';
